                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                {{-- <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <a href="{{ route('indexDataAlternatif') }}"
                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{-- <a href="{{ route('indexPenilaian') }}" class="text-secondary text-decoration-none">Data
                                        Penilaian --}}
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{-- <a href="{{ route('indexPerhitungan') }}"
                                        class="text-secondary text-decoration-none">Data Perhitungan
                                    </a> --}}
                                </div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{-- <a href="{{ route('indexHasil') }}" class="text-secondary text-decoration-none">Data
                                        Hasil Akhir
                                    </a> --}}
                                </div>
                            </div>
